========================================================================
    ACTIVEX CONTROL DLL : CalculatorControl Project Overview
========================================================================

ControlWizard has created this project for your CalculatorControl ActiveX Control
...
that make up your CalculatorControl ActiveX Control DLL.

CalculatorControl.vcxproj
...
CalculatorControl.vcxproj.filters
...
CalculatorControl.def
    This file contains information about the ActiveX Control DLL that
    must be provided to run with Microsoft Windows.

CalculatorControl.idl
    This file contains the Object Description Language source code for the
    type library of your control.

CalculatorControl.ico
    This file contains an icon that will appear in the About box.  This icon
    is included by the main resource file CalculatorControl.rc.

/////////////////////////////////////////////////////////////////////////////
CCalculatorControlCtrl control:

CalculatorControlCtrl.h
    This file contains the declaration of the CCalculatorControlCtrl C++ class.

CalculatorControlCtrl.cpp
    This file contains the implementation of the CCalculatorControlCtrl C++ class.

CalculatorControlPropPage.h
    This file contains the declaration of the CCalculatorControlPropPage C++ class.

CalculatorControlPropPage.cpp
    This file contains the implementation of the CCalculatorControlPropPage C++ class.

CCalculatorControlCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CCalculatorControlCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file CalculatorControl.rc.
...
stdafx.h, stdafx.cpp
    ...
    named CalculatorControl.pch and a precompiled types (PCT) file named stdafx.obj.
